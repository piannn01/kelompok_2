...
<body>
    <header>
        <h3>Formulir Edit Data Mabes Polry</h3>
    </header>
    <form action="proses-edit.php" method="POST">
        ...
        <p>
            ...
            <input type="text" name="nis" placeholder="nis" value="<?php echo $siswa['nim'] ?>" />
        </p>
        <p>
        ...
        <p>
            ...
            <input type="text" name="hobby" placeholder="hobby" value="<?php echo $siswa['hobby'] ?>" />
        </p>
        <p>
